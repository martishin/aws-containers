...
namespace DirectoryService.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        public EmployeeController(ILogger<EmployeeController> logger)
        {
            ...
            _logger = logger;
            string endpointOverride = Environment.GetEnvironmentVariable("DYNAMO_ENDPOINT_OVERRIDE");
            ...
            if(!String.IsNullOrEmpty(endpointOverride)) {
                dynamoDBConfig.ServiceURL = endpointOverride;
            }

            _logger.LogInformation($"Using DYNAMO_ENDPOINT_OVERRIDE: {endpointOverride}");
            _logger.LogInformation($"Using AWS_ACCESS_KEY_ID: {accessKeyId}");
            _logger.LogInformation($"Using AWS_SECRET_ACCESS_KEY: {secretAccessKey}");

            _dynamoDBClient = new AmazonDynamoDBClient(accessKeyId, secretAccessKey, dynamoDBConfig);
        }
